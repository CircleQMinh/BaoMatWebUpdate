<%-- 
    Document   : ajax-insert-product-for-emp
    Created on : Dec 29, 2020, 12:58:45 PM
    Author     : ASUS
--%>
...
<html>
    ...
    <body>      
        <%
            ...
            { 
                try {
                    Unapprovedproduct  pro = new Unapprovedproduct(name,des,intprice,intqua,cate,url,today);
                    ProductDao.saveunPro(pro);
