 ...
 * @author ASUS
 */
public class AppPayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(CartService.getTotalCost(cart.getItems()) < csm.getMoney()){
            ...
            ord.setCustomer(csm);
            ord.setPaymentType("app account");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AppPayServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
